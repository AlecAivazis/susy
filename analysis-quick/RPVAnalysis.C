...
void RPVAnalysis::run(){
    ...
    signal600Chain->Add("/hadoop/cms/store/user/aaivazis/samples/signal/signal600.root");
...
void RPVAnalysis::plotHistograms(){
    ...
    */
    ...
    leg->AddEntry(signal600["met"], "data", "l");
