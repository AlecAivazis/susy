doZZ(int numFiles = -1, std::string file_name="zz")
{
  ...
  looper->ScanChain(zz, file_name + "_4l", numFiles); 
  ...
  looper->ScanChain(zz, file_name + "_2l2n", numFiles); 
  ...
  looper->ScanChain(zz, file_name + "_2l2q", numFiles); 
}
